...
#define UE_PROJECT_NAME MultiplayerImp
#define UE_TARGET_NAME MultiplayerImpEditor
#define UE_MODULE_NAME "MultiplayerImp"
...
#define MULTIPLAYERIMP_API DLLEXPORT
